...
<html>
<head>
<title>Past Prescriptions - MedAxis Doctor</title>
...
<a href="doctorViewPrescriptions.jsp" class="active">Past Prescriptions</a>
...
<h2 class="page-header">Past Prescriptions</h2>
...
rs = st.executeQuery("SELECT * FROM PRESCRIPTION WHERE DOCTOR_NAME = '"+doctorName+"' ORDER BY PRESCRIPTION_DATE DESC");
...
<a href="doctorPrescription.jsp" class="btn btn-primary mt-3">Write New Prescription</a>
</div>
<%
}
