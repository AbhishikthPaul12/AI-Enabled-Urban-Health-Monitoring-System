...
<input name="phone" placeholder="Enter your phone number" class="form-control" required>
</div>

<button class="btn btn-save w-100 text-white">Save Profile</button>
